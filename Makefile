...
STUDENT_LIBS = vector list polygon color body scene forces collision player
...
LIBS = $(LIB_MATH) $(shell sdl2-config --libs) -lSDL2 -lSDL2_gfx -lSDL2_image -lSDL2_ttf -lSDL2_mixer
